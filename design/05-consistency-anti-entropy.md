...
| expiry sweep budget | 128 records / 8 partitions / 2 ms target | const (marekvs-engine) | no | fair own-partition discovery; park TTL-free partitions and schedule deadlines; commit generations invalidate proofs |
